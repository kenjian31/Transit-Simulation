 ...
 ******************************************************************************/
 ...
 TEST_F(PassengerTests, Update){
   passenger = new Passenger(1, "name");
 ...
 TEST_F(PassengerTests, GetOnBus){
   passenger = new Passenger(1, "name");
   passenger->GetOnBus();
   // passenger1 = new Passenger(1, "nam");
   passenger->Update();
   EXPECT_EQ(passenger->GetTotalWait(), 2);
 }
 ...
 TEST_F(PassengerTests, IsOnBus){
   passenger = new Passenger(1, "name");
   EXPECT_EQ(passenger->GetTotalWait(), false);
   passenger->GetOnBus();
   EXPECT_EQ(passenger->GetTotalWait(), true);
 }
...
TEST_F(PassengerTests, Report){
  passenger = new Passenger(1, "name");
  passenger2 = new Passenger(2, "KEN");
  std::string expected_output_1 = "Name: name";
  std::string expected_output_2 = "\tTime on bus: 1";
